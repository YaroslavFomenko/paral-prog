...
В данной работе параллельная MPI-программа умножения матриц запущена на суперкомпьютере «Сергей Королёв» с использованием планировщика Slurm. Проведены эксперименты с разными размерами матриц и разным количеством процессов.
...
| submit_job.sh | Скрипт для запуска через Slurm |
